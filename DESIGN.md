...
- The root workspace is a native three-tab structure: Recipes, Watch, Inbox.
- Recipes is the default tab. Watch and Inbox are destinations, not cards that
  need to be discovered inside a home feed.
...
- Capture Recipes, Watch, Inbox, recipe detail, Focus Mode, welcome, and Share
  Extension at the project simulator size before a design checkpoint.
