...
this policy through the backend's S3 client into local and Mac mini MinIO
automatically. Apply the same policy to every externally managed environment's
private bucket before production.
